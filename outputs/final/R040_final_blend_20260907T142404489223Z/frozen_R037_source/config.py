...
class Config:
    ...
    supervised_weighting: str | None = None
    early_stop_screen: dict | None = None  # immutable, pre-registered challenger kill switch
    ...
    def validate(self):
        ...
        if self.feature_profile in {"react2026_static", "react2026_static_customer_history", "react2026_static_customer_history_relationships", "react2026_static_customer_history_relationships_device_global", "react2026_static_customer_history_relationships_device_global_velocity", "react2026_static_customer_history_relationships_device_global_broad_velocity", REACT2026_MERCHANT_ONEHOT_PROFILE, REACT2026_CUSTOMER_AMOUNT_30D_PROFILE, REACT2026_CUSTOMER_MERCHANT_PROFILE, REACT2026_CUSTOMER_CATEGORY_PROFILE, REACT2026_DEVICE_RECENT_SHARING_PROFILE, REACT2026_MERCHANT_HISTORY_PROFILE, REACT2026_MERCHANT_AMOUNT_HISTORY_PROFILE, REACT2026_CUSTOMER_NEW_MERCHANTS_PROFILE, REACT2026_MERCHANT_NEW_CUSTOMERS_PROFILE, REACT2026_DEVICE_LOCATION_PROFILE}:
            ...
            if self.feature_profile in {"react2026_static_customer_history_relationships", "react2026_static_customer_history_relationships_device_global", "react2026_static_customer_history_relationships_device_global_velocity", "react2026_static_customer_history_relationships_device_global_broad_velocity", REACT2026_MERCHANT_ONEHOT_PROFILE, REACT2026_CUSTOMER_AMOUNT_30D_PROFILE, REACT2026_CUSTOMER_MERCHANT_PROFILE, REACT2026_CUSTOMER_CATEGORY_PROFILE, REACT2026_DEVICE_RECENT_SHARING_PROFILE, REACT2026_MERCHANT_HISTORY_PROFILE, REACT2026_MERCHANT_AMOUNT_HISTORY_PROFILE, REACT2026_CUSTOMER_NEW_MERCHANTS_PROFILE, REACT2026_MERCHANT_NEW_CUSTOMERS_PROFILE, REACT2026_DEVICE_LOCATION_PROFILE}:
                from .data import REACT2026_CUSTOMER_RELATIONSHIP_FEATURES
                expected.update(REACT2026_CUSTOMER_RELATIONSHIP_FEATURES)
            if self.feature_profile in {"react2026_static_customer_history_relationships_device_global", "react2026_static_customer_history_relationships_device_global_velocity", "react2026_static_customer_history_relationships_device_global_broad_velocity", REACT2026_MERCHANT_ONEHOT_PROFILE, REACT2026_CUSTOMER_AMOUNT_30D_PROFILE, REACT2026_CUSTOMER_MERCHANT_PROFILE, REACT2026_CUSTOMER_CATEGORY_PROFILE, REACT2026_DEVICE_RECENT_SHARING_PROFILE, REACT2026_MERCHANT_HISTORY_PROFILE, REACT2026_MERCHANT_AMOUNT_HISTORY_PROFILE, REACT2026_CUSTOMER_NEW_MERCHANTS_PROFILE, REACT2026_MERCHANT_NEW_CUSTOMERS_PROFILE, REACT2026_DEVICE_LOCATION_PROFILE}:
                from .data import REACT2026_DEVICE_GLOBAL_FEATURES
                expected.update(REACT2026_DEVICE_GLOBAL_FEATURES)
            if self.feature_profile == "react2026_static_customer_history_relationships_device_global_velocity":
                from .data import REACT2026_VELOCITY_FEATURES
                expected.update(REACT2026_VELOCITY_FEATURES)
            if self.feature_profile == REACT2026_CUSTOMER_AMOUNT_30D_PROFILE:
                from .data import REACT2026_VELOCITY_FEATURES, REACT2026_CUSTOMER_AMOUNT_30D_FEATURES
                expected.update(REACT2026_VELOCITY_FEATURES); expected.update(REACT2026_CUSTOMER_AMOUNT_30D_FEATURES)
            if self.feature_profile == REACT2026_CUSTOMER_MERCHANT_PROFILE:
                from .data import REACT2026_VELOCITY_FEATURES, REACT2026_CUSTOMER_MERCHANT_FEATURES
                expected.update(REACT2026_VELOCITY_FEATURES); expected.update(REACT2026_CUSTOMER_MERCHANT_FEATURES)
            if self.feature_profile == REACT2026_CUSTOMER_CATEGORY_PROFILE:
                from .data import REACT2026_VELOCITY_FEATURES, REACT2026_CUSTOMER_MERCHANT_FEATURES, REACT2026_CUSTOMER_CATEGORY_FEATURES
            ...
            if self.feature_profile == REACT2026_DEVICE_RECENT_SHARING_PROFILE:
                from .data import REACT2026_VELOCITY_FEATURES, REACT2026_CUSTOMER_MERCHANT_FEATURES, REACT2026_DEVICE_RECENT_SHARING_FEATURES
                expected.update(REACT2026_VELOCITY_FEATURES); expected.update(REACT2026_CUSTOMER_MERCHANT_FEATURES); expected.update(REACT2026_DEVICE_RECENT_SHARING_FEATURES)
            if self.feature_profile == REACT2026_MERCHANT_HISTORY_PROFILE:
                from .data import REACT2026_VELOCITY_FEATURES, REACT2026_CUSTOMER_MERCHANT_FEATURES, REACT2026_MERCHANT_HISTORY_FEATURES
                expected.update(REACT2026_VELOCITY_FEATURES); expected.update(REACT2026_CUSTOMER_MERCHANT_FEATURES); expected.update(REACT2026_MERCHANT_HISTORY_FEATURES)
            if self.feature_profile == REACT2026_MERCHANT_AMOUNT_HISTORY_PROFILE:
                from .data import REACT2026_VELOCITY_FEATURES, REACT2026_CUSTOMER_MERCHANT_FEATURES, REACT2026_MERCHANT_HISTORY_FEATURES, REACT2026_MERCHANT_AMOUNT_HISTORY_FEATURES
                expected.update(REACT2026_VELOCITY_FEATURES); expected.update(REACT2026_CUSTOMER_MERCHANT_FEATURES); expected.update(REACT2026_MERCHANT_HISTORY_FEATURES); expected.update(REACT2026_MERCHANT_AMOUNT_HISTORY_FEATURES)
            if self.feature_profile == REACT2026_CUSTOMER_NEW_MERCHANTS_PROFILE:
                from .data import REACT2026_VELOCITY_FEATURES, REACT2026_CUSTOMER_MERCHANT_FEATURES, REACT2026_MERCHANT_HISTORY_FEATURES, REACT2026_CUSTOMER_NEW_MERCHANTS_FEATURES
                expected.update(REACT2026_VELOCITY_FEATURES); expected.update(REACT2026_CUSTOMER_MERCHANT_FEATURES); expected.update(REACT2026_MERCHANT_HISTORY_FEATURES); expected.update(REACT2026_CUSTOMER_NEW_MERCHANTS_FEATURES)
            if self.feature_profile == REACT2026_MERCHANT_NEW_CUSTOMERS_PROFILE:
                from .data import REACT2026_VELOCITY_FEATURES, REACT2026_CUSTOMER_MERCHANT_FEATURES, REACT2026_MERCHANT_HISTORY_FEATURES, REACT2026_MERCHANT_NEW_CUSTOMERS_FEATURES
                expected.update(REACT2026_VELOCITY_FEATURES); expected.update(REACT2026_CUSTOMER_MERCHANT_FEATURES); expected.update(REACT2026_MERCHANT_HISTORY_FEATURES); expected.update(REACT2026_MERCHANT_NEW_CUSTOMERS_FEATURES)
            if self.feature_profile == REACT2026_DEVICE_LOCATION_PROFILE:
                from .data import REACT2026_VELOCITY_FEATURES, REACT2026_CUSTOMER_MERCHANT_FEATURES, REACT2026_MERCHANT_HISTORY_FEATURES, REACT2026_DEVICE_LOCATION_FEATURES
                expected.update(REACT2026_VELOCITY_FEATURES); expected.update(REACT2026_CUSTOMER_MERCHANT_FEATURES); expected.update(REACT2026_MERCHANT_HISTORY_FEATURES); expected.update(REACT2026_DEVICE_LOCATION_FEATURES)
            if self.feature_profile == "react2026_static_customer_history_relationships_device_global_broad_velocity":
                from .data import REACT2026_VELOCITY_FEATURES, REACT2026_BROAD_VELOCITY_FEATURES
                expected.update(REACT2026_VELOCITY_FEATURES); expected.update(REACT2026_BROAD_VELOCITY_FEATURES)
            if self.feature_profile == REACT2026_MERCHANT_ONEHOT_PROFILE:
                from .data import REACT2026_VELOCITY_FEATURES
        ...
        if self.supervised_weighting not in {None, "exponential_recent_60d"}:
            raise ValueError("Unknown supervised_weighting")
        if self.early_stop_screen is not None:
            required_screen = {"fold", "references", "maximum_drops"}
            if set(self.early_stop_screen) != required_screen or not 0 <= self.early_stop_screen["fold"] < self.n_splits:
                raise ValueError("early_stop_screen requires fold, references, and maximum_drops")
            if set(self.early_stop_screen["references"]) != set(self.early_stop_screen["maximum_drops"]):
                raise ValueError("early_stop_screen references and maximum_drops must name the same windows")
