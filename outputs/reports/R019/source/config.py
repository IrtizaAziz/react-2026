...
class Config:
    ...
    def validate(self):
        ...
        from .data import REACT2026_CUSTOMER_AMOUNT_30D_PROFILE, REACT2026_CUSTOMER_MERCHANT_PROFILE, REACT2026_CUSTOMER_CATEGORY_PROFILE, REACT2026_DEVICE_RECENT_SHARING_PROFILE, REACT2026_MERCHANT_HISTORY_PROFILE
