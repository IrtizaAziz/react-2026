...
from .data import REACT2026_CUSTOMER_HISTORY_FEATURES, REACT2026_STATIC_FEATURES, load_training
...
def assert_static_contract(config, frame, pairs):
    ...
    if config.feature_profile == "react2026_static_customer_history":
